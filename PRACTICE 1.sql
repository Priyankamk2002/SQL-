...
-- 5.alterWrite a SQL query to find all transactions where the total_sale is greater than 1000.:
...
-- 8.alterWrite a SQL query to find the top 5 customers based on the highest total sales **:
SELECT 
    customer_id,
